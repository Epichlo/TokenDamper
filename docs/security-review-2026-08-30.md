...
Not yet run. Targets are in **§7.2**; this section is where the revision goes.

One thing worth stating here because it is a defence and §7.2 is a target list: **F-01 and F-05 have
each already survived a downgrade** — R-03 retracted F-01's membership oracle after an equal-length
control showed no signal, and F-05 was narrowed from "any prose line" to "comments and docstrings in
